...
srun -n 1 python 4_slice3d_parallel.py --cores 30 -p full_with_smoothing_1 --smoothing -d /global/cfs/cdirs/m3363/www/cosmoUniverse_2020_11_4parE_cGAN/Sg1.1 -i 64
